...
#' @export 
mdp_brkga <- function(DistanceMatrix, m, method = 0L, LS_INTERVAL = 10L, MAX_TIME = 10L, p = 500L, pe = 0.20, pm = 0.10, rhoe = 0.70, lambda = 0.01, K = 3L, THREADS = 8L, X_INTVL = 100L, X_NUMBER = 2L, MAX_GENS = 100L, RESET_AFTER = 200L, verbose = FALSE, rngSeed = 0L) {
    .Call(`_brkga_mdp_brkga`, DistanceMatrix, m, method, LS_INTERVAL, MAX_TIME, p, pe, pm, rhoe, lambda, K, THREADS, X_INTVL, X_NUMBER, MAX_GENS, RESET_AFTER, verbose, rngSeed)
}
